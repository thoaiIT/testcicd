...
public final class Result extends HashMap<String, Object> {
	...
	public static final Result DATA(Object data) {
	...
	public static final String KEY_TREE = "root";

	public static final Result TREE(List<Tree> tree) {
		Result result = new Result();
		result.put(KEY_LIST, tree);
		return result;
	}
	...
	@SuppressWarnings("unchecked")
	public <K, V> V getData() {
		return (V) get(KEY_DATA);
	}
