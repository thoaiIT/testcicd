  ...
  var n = new ((function () {
        ...
        (i = [
            ...
            set: function (e) {
              if (12 !== e.length)
                throw new RangeError(
                  "There must be 12 months for ".concat(
                    this.language,
                    " language"
                  )
                );
          ...
          },
          {
            ...
            set: function (e) {
              if (12 !== e.length)
                throw new RangeError(
                  "There must be 12 abbreviated months for ".concat(
                    this.language,
                    " language"
                  )
                );
          ...
          },
          {
            ...
            set: function (e) {
              if (7 !== e.length)
                throw new RangeError(
                  "There must be 7 days for ".concat(this.language, " language")
                );
              this._days = e;
            },
          },
    ...
    s = {
      ...
      compareDates: function (e, t) {
        ...
        return (
          this.useUtc
            ? (a.setUTCHours(0, 0, 0, 0), i.setUTCHours(0, 0, 0, 0))
  ...
  const d = {
    ...
    computed: {
      ...
      computedInputClass: function () {
        return this.bootstrapStyling
          ? "string" == typeof this.inputClass
            ? [this.inputClass, "form-control"].join(" ")
            : i({ "form-control": !0 }, this.inputClass)
          : this.inputClass;
      },
    },
    watch: {
    ...
    methods: {
      ...
      parseTypedDate: function (e) {
        if (
          ([27, 13].includes(e.keyCode) && this.input.blur(), this.typeable)
        ) {
      ...
      inputBlurred: function () {
        this.typeable &&
          isNaN(Date.parse(this.input.value)) &&
          (this.clearDate(),
        ...
        e.calendarButton
          ? a(
              ...
              [
                a(
                  "span",
                  { class: { "input-group-text": e.bootstrapStyling } },
                  [
                    a("i", { class: e.calendarButtonIcon }, [
                      e._v(
                        "\n        " +
          ...
          ? a(
              ...
              [
                a(
                  ...
                  { class: { "input-group-text": e.bootstrapStyling } },
                  [
                    a("i", { class: e.clearButtonIcon }, [
                      e.clearButtonIcon ? e._e() : a("span", [e._v("×")]),
                    ]),
                  ]
                ),
              ]
  ...
  const u = {
    ...
    computed: {
      ...
      blankDays: function () {
        var e = this.pageDate,
          t = this.useUtc
            ? new Date(Date.UTC(e.getUTCFullYear(), e.getUTCMonth(), 1))
            : new Date(
                e.getFullYear(),
                e.getMonth(),
                1,
        ...
        return this.mondayFirst
          ? this.utils.getDay(t) > 0
            ? this.utils.getDay(t) - 1
            : 6
          : this.utils.getDay(t);
      },
      days: function () {
        for (
          var e = this.pageDate,
            ...
            i = this.utils.daysInMonth(
              this.utils.getFullYear(a),
              this.utils.getMonth(a)
            ),
            n = 0;
          n < i;
          n++
    ...
    methods: {
      ...
      isPreviousMonthDisabled: function () {
        ...
        return (
          this.utils.getMonth(this.disabledDates.to) >=
            this.utils.getMonth(e) &&
          this.utils.getFullYear(this.disabledDates.to) >=
            this.utils.getFullYear(e)
        );
      },
      nextMonth: function () {
      ...
      isSelectedDate: function (e) {
        return (
          this.selectedDate && this.utils.compareDates(this.selectedDate, e)
        );
      },
      isDisabledDate: function (e) {
        ...
        return (
          ...
          void 0 !== this.disabledDates.to &&
            ...
            e < this.disabledDates.to &&
            (a = !0),
          void 0 !== this.disabledDates.from &&
            this.disabledDates.from &&
            e > this.disabledDates.from &&
            (a = !0),
          ...
          void 0 !== this.disabledDates.days &&
            -1 !== this.disabledDates.days.indexOf(this.utils.getDay(e)) &&
            (a = !0),
          void 0 !== this.disabledDates.daysOfMonth &&
            -1 !==
              this.disabledDates.daysOfMonth.indexOf(this.utils.getDate(e)) &&
            (a = !0),
          "function" == typeof this.disabledDates.customPredictor &&
            this.disabledDates.customPredictor(e) &&
            (a = !0),
          a)
        );
      },
      isHighlightedDate: function (e) {
        ...
        return (
          ...
          this.isDefined(this.highlighted.from) &&
            ...
            (a = e >= this.highlighted.from && e <= this.highlighted.to),
          void 0 !== this.highlighted.days &&
            -1 !== this.highlighted.days.indexOf(this.utils.getDay(e)) &&
            (a = !0),
          void 0 !== this.highlighted.daysOfMonth &&
            -1 !==
              this.highlighted.daysOfMonth.indexOf(this.utils.getDate(e)) &&
            (a = !0),
          "function" == typeof this.highlighted.customPredictor &&
            this.highlighted.customPredictor(e) &&
            (a = !0),
          a)
        );
      },
      ...
      [
        ...
        a("header", [
          ...
          a(
            ...
            [
              e._v(
                e._s(e.isYmd ? e.currYearName : e.currMonthName) +
                  " " +
                  e._s(e.isYmd ? e.currMonthName : e.currYearName)
              ),
            ]
          ),
          e._v(" "),
        ...
        a(
          ...
          [
            e._l(e.daysOfWeek, function (t) {
              return a(
                "span",
                { key: t.timestamp, staticClass: "cell day-header" },
                [e._v(e._s(t))]
              );
            }),
            e._v(" "),
  ...
  const f = {
      ...
      months: function () {
        for (
          var e = this.pageDate,
            t = [],
            a = this.useUtc
              ? new Date(Date.UTC(e.getUTCFullYear(), 0, e.getUTCDate()))
              : new Date(
                  e.getFullYear(),
                  0,
                  e.getDate(),
    ...
    methods: {
      ...
      isPreviousYearDisabled: function () {
        return (
          !(!this.disabledDates || !this.disabledDates.to) &&
          this.utils.getFullYear(this.disabledDates.to) >=
      ...
      isNextYearDisabled: function () {
        return (
          !(!this.disabledDates || !this.disabledDates.from) &&
          this.utils.getFullYear(this.disabledDates.from) <=
            this.utils.getFullYear(this.pageDate)
        );
      },
      ...
      isSelectedMonth: function (e) {
        return (
          ...
          this.utils.getFullYear(this.selectedDate) ===
            this.utils.getFullYear(e) &&
          this.utils.getMonth(this.selectedDate) === this.utils.getMonth(e)
        );
      },
        ...
        for (
          var e = this.pageDate,
            ...
            a = this.useUtc
              ? new Date(
                  Date.UTC(
                    10 * Math.floor(e.getUTCFullYear() / 10),
                    e.getUTCMonth(),
                    e.getUTCDate()
                  )
                )
              : new Date(
                  10 * Math.floor(e.getFullYear() / 10),
                  e.getMonth(),
                  e.getDate(),
                  e.getHours(),
                  e.getMinutes()
    ...
    methods: {
      ...
      isPreviousDecadeDisabled: function () {
        return (
          !(!this.disabledDates || !this.disabledDates.to) &&
          this.utils.getFullYear(this.disabledDates.to) >
            10 * Math.floor(this.utils.getFullYear(this.pageDate) / 10) - 1
        );
      },
      nextDecade: function () {
      ...
      isNextDecadeDisabled: function () {
        return (
          !(!this.disabledDates || !this.disabledDates.from) &&
          this.utils.getFullYear(this.disabledDates.from) <
            10 * Math.ceil(this.utils.getFullYear(this.pageDate) / 10)
        );
      },
      ...
      methods: {
        ...
        showCalendar: function () {
          return (
            !this.disabled &&
            !this.isInline &&
            (this.isOpen ? this.close(!0) : void this.setInitialView())
          );
        },
          ...
          if (!this.allowedToShowView(e))
            throw new Error(
              "initialView '"
                ...
                .concat(this.minimumView, "' and maximum '")
                .concat(this.maximumView, "'")
            );
          switch (e) {
            case "year":
        ...
        showDayCalendar: function () {
          return (
            ...
            (this.close(), (this.showDayView = !0), !0)
          );
        },
        showMonthCalendar: function () {
          return (
            !!this.allowedToShowView("month") &&
            (this.close(), (this.showMonthView = !0), !0)
          );
        },
        showYearCalendar: function () {
          return (
            !!this.allowedToShowView("year") &&
            (this.close(), (this.showYearView = !0), !0)
          );
        },
        setDate: function (e) {
          var t = new Date(e);
      ...
      return (function (e, t) {
        ...
        if (!i.ids.has(e)) {
          ...
          if (
            ...
            l[s] && i.element.removeChild(l[s]),
              l.length
                ? i.element.insertBefore(r, l[s])
